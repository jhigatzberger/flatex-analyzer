...
import { Box, Typography, useTheme, useMediaQuery, IconButton, Drawer, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Divider } from '@mui/material';
...
export function Header() {
    ...
    const drawerContent = (
        ...
        >
            ...
            >
                <Link href="/" style={{ gap: 2, textDecoration: 'none', color: theme.palette.text.primary, display: 'flex', alignItems: 'center' }}>
